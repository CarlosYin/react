...
export default class Header extends Component {
  ...
  //下载app事件
  DownApp = () => {
    let downlink = "https://itunes.apple.com/app/id590338362";
  ...
  render() {
    ...
    return (
      <div className="topfix" data-reactid="3">
        <h1 className="topfl" data-reactid="4">
          <span className="topplh" data-reactid="5">网易云音乐</span>
          <svg className="topsvg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 284 50" data-reactid="6">
            <g fill="#fff" data-reactid="7">
              ...
              <path d="m154.33 10.02h37.67c-.106-1.835-.617-3.01-2.354-3.01h-37.67c.106 1.833.618 3.01 2.354 3.01" data-reactid="14"></path><path d="m191.6 20.02h-40.624c.108 1.835.627 3.01 2.39 3.01h40.623c-.108-1.835-.628-3.01-2.389-3.01" data-reactid="15"></path>
              <path fillRule="evenodd" d="m232 37.03h-25.01v-3.01h25.01v3.01" data-reactid="16"></path><path d="m221.98 10.02v-3.996h-5v3.995h5" data-reactid="17"></path><path d="m237.61 9.03h-38.613c.107 1.816.623 2.979 2.376 2.979h38.614c-.107-1.817-.623-2.979-2.377-2.979" data-reactid="18"></path>
